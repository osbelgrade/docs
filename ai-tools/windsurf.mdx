...
![Windsurf Pn](/images/Windsurf.png)
...
Launch Windsurf and open your OS:B documentation repository.
...
- No romanticization or performance of culture
...
**Code Generation**\
Use Cascade to generate Python poem templates following OS:B standards. Reference `.windsurfrules` for consistent formatting.
...
<Info>
  **Troubleshooting** Ask Cascade about Mintlify-specific syntax, navigation structure, or formatting issues. The AI can reference your entire project context to provide relevant solutions.
</Info>
