---
title: "OS:Belgrade"
description: "OS:B is technical documentation for a city that operates on fundamentally different cultural software. As such, it documents Belgrade's protocols, processes, and underlying code through poetry formatted as code and software documentation. Each poem functions as a specification, troubleshooting guide, or system analysis.

Created in Mintlify and written in pseudo-valid Python, OS:B exists at the intersection of poetry, cultural theory, and software development.OS:B is a creative investigation that treats displacement as a debugging process and cultural integration as system installation. "
---

![Download Pn](/CleanShot2025-09-29at13.53.05@2x.png)
