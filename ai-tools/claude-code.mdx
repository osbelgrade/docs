---
title: "Claude Code"
description: "Claude Code is Anthropic's official CLI tool. This short guide will help you set up Claude Code to help you write and maintain further personal documentation."
icon: "asterisk"
---

![Claudio Sv](/images/claudio.svg)
...
- You can push back on ideas-this can lead to better documentation. 
  Cite sources and explain your reasoning when you do so
...
- Search for existing information before adding new content. 
  Avoid duplication unless it is done for a strategic reason
